...
public record StudentInfoResponseDto(
        Long userNo,
        Set<LessonSubCategory> lessonSubcategoryList,
        Set<StudentRegions> regionList
) {

    public static StudentInfoResponseDto from(Long userNo, Set<LessonSubCategory> lessonSubcategoryList, Set<StudentRegions> regionList) {
